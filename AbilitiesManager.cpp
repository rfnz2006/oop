...
void AbilitiesManager::ApplicationOfAbilities(Field& field, int x, int y) { 
    ...
    temp_abil->UseAbilities(field, x, y);// вызывается use_abilities для соответствующего класса
...
bool AbilitiesManager::Empty() const
{
	return queue_abilities.empty();
}

size_t AbilitiesManager::Size() const
{
